...
META COPY(ContainerBasicHelperFunctions)
...
META COPY(ArrayBasedContainerHelperFunctions)
...
META COPY(ContainerPushHelperFunctions)
type& Push 
...
META COPY(ContainerPushFrontHelperFunctions)
type& PushFront 
(const type& InitialData) 
{ 
...
META COPY(ContainerRemoveHelperFunctions)
template<class compare_type> 
...
#define ScopeTemporaryMemory(Arena) scope_temporary_memory ScopeTempMem##__LINE__(Arena)
        ...
        struct array
    {
        ...
        META PASTE(ContainerBasicHelperFunctions);
        META PASTE(ArrayBasedContainerHelperFunctions);
    };
        ...
        struct pushable_array
    {
        ...
        META PASTE(ContainerBasicHelperFunctions);
        META PASTE(ContainerPushHelperFunctions);
        META PASTE(ContainerRemoveHelperFunctions);
        META PASTE(ArrayBasedContainerHelperFunctions);
    };
        ...
        struct doubly_linked_list
    {
        ...
        META PASTE(ContainerBasicHelperFunctions);
        META PASTE(ContainerPushHelperFunctions);
        META PASTE(ContainerPushFrontHelperFunctions);
        META PASTE(ContainerRemoveHelperFunctions);
    };
